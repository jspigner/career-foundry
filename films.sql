-- In pgAdmin 4, I ran the following queries re: film titles, genres, and categories. 

-- Check existing film genres in the category table 
SELECT name, category_id FROM category 

-- Add new genres 
-- I added five new genres: Thriller, Crime, Mystery, Romance, and War. 
...
-- Order the data 
-- I selected every film from the film table, with the films sorted by title from A to Z, then by most recent release year, 
